...
def main():
    ...
    generate_pages_recursevely("content", "template.html", "public")


def generate_pages_recursevely(dir_path_content, template_path, dest_dir_path):
    ...
    for filename in files:
        ...
        if os.path.isfile(file_path):
            ...
            generate_pages_recursevely(file_path, template_path, os.path.join(dest_dir_path, filename))
